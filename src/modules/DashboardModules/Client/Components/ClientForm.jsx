...
import { clientTypeOptions } from "../../../../constant/clientType";
...
export const ClientForm = ({ submitButtonText = "save", isSubmitting, initialValues }) => {
  const { t } = useTranslation("layout");
  ...
  return (
    <Form className="space-y-4">
      ...
      <SelectField name="financing_type" label={t("financing_type")} options={clientTypeOptions} />
