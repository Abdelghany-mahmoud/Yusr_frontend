...
import { CustomerDocuments } from "./ClientDocs/CustomerDocuments";
...
function ShowCustomer({ customer }) {
  ...
  const { data: customerDocs, isLoading: isCustomerDocsLoading } = useGetData({
    endpoint: `documents?client_id=${customer?.id}?page=${page}`,
    queryKey: ["documents-customer", customer?.id, page],
    enabledKey: isOpen,
  });
    ...
    <Modal
      ...
      btnText={
        <div
          ...
          data-tip={isLegalSupervisor ? t("documents") : t("show_customer")}
        >
          <IoEyeOutline />
        </div>
      }
      ...
      title={isLegalSupervisor ? t("documents") : t("customer_details")}
    >
      {isLoading ? (
        ...
        <div className="space-y-6">
          ...
          <CustomerDocuments
            ...
            isCustomerDocsLoading={isCustomerDocsLoading}
            page={page}
            setPage={setPage}
            t={t}
          />
